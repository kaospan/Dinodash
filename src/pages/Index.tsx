...
const Index = () => {
  ...
  return (
    <div className="relative h-[100svh] min-h-[100svh] w-screen overflow-hidden" style={{ backgroundImage: `url(${bgImage})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: isMobile ? 'scroll' : 'fixed' }}>
