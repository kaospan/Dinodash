...
describe('Dinodash 3D movement',()=>{
  ...
  it('glides a player across a void gap from a directional arrow platform',()=>{
    const level:Level3D={
      id:999,name:'arrow glide test',width:5,depth:1,maxHeight:3,
      cells:[
        {x:0,y:0,height:1,type:'platform'},
        {x:1,y:0,height:0,type:'void'},
        {x:2,y:0,height:0,type:'void'},
        {x:3,y:0,height:1,type:'floor'},
        {x:4,y:0,height:1,type:'goal'},
      ],
      playerStart:{x:0,y:0,height:1},goal:{x:4,y:0,height:1},
    };
  ...
  it('does not glide in a direction not permitted by the arrow',()=>{
    const level:Level3D={
      id:1000,width:3,depth:1,maxHeight:3,
      cells:[{x:0,y:0,height:1,type:'platform'},{x:1,y:0,height:0,type:'void'},{x:2,y:0,height:1,type:'floor'}],
      playerStart:{x:0,y:0,height:1},goal:{x:2,y:0,height:1},
    };
    const platforms=[{x:0,y:0,dx:1,dy:0,directions:['right' as const]}];
